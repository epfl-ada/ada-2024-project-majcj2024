north_america = [
    'United States of America', 'Canada', 'Mexico', 'Cuba', 'Puerto Rico', 'Panama',
    'Jamaica', 'Costa Rica', 'Bahamas', 'Haiti'
]
...
europe = [
    ...
    'German Democratic Republic', 'Yugoslavia', 'Ireland', 'Switzerland', 'Austria',
    ...
    'Kingdom of Italy', 'Crimea', 'German Language', 'Ukrainian SSR'
]

asia = [
    'India', 'Japan', 'Hong Kong', 'South Korea', 'China', 'Soviet Union', 'Philippines',
...
south_america = [
    'Argentina', 'Brazil', 'Chile', 'Colombia', 'Venezuela', 'Peru', 'Uruguay',
